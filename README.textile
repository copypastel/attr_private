...
AttrPrivate adds the attr_private method to active record models.  This is a tool which is meant to be used to help programmers working in teams write defensive code.
